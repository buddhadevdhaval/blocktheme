...
$ambrygen_heading_class        = $ambrygen_is_history_variation ? 'heading-3' : 'heading-1';
$ambrygen_image_position_class = 'right' === $ambrygen_image_position ? ' block-rtl' : '';
$ambrygen_variation_class      = $ambrygen_is_history_variation ? ' variation-history-block' : '';
	...
	<div class="ai-hero__grid">
		<div class="ai-hero__col ai-hero__col--images">
			<div class="ai-hero__images">
				...
				<div class="ai-hero__image-wrapper<?php echo $ambrygen_is_history_variation ? '' : ' ai-hero__image-wrapper--full'; ?> js-gsap-fade">
				...
				<?php if ( $ambrygen_is_history_variation ) : ?>
					<div class="ai-hero__image-wrapper js-gsap-fade">
						<div class="ai-hero__image">
							<div class="ai-hero__image-container">
								<?php
