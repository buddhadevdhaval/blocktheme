...
/***/ "./assets/src/blocks/awards-block/block.json"
/*!***************************************************!*\
  !*** ./assets/src/blocks/awards-block/block.json ***!
  \***************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/awards-block","title":"Awards Block","category":"ambrygen","icon":"awards","description":"Awards content block with description, CTAs, and award logo listing.","textdomain":"ambrygen-web","supports":{"html":false,"align":["wide","full"],"spacing":{"margin":true,"padding":true}},"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js","render":"file:./render.php","attributes":{"blockId":{"type":"string","default":""},"title":{"type":"string","default":"Awards"},"description":{"type":"string","default":""},"awards":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"imageId":{"type":"number"},"imageUrl":{"type":"string"},"imageAlt":{"type":"string"}}},"default":[]},"isHeaderVertical":{"type":"boolean","default":false}},"example":{"attributes":{"title":"Awards","description":"<p>Recognition and awards from our team and community.</p>"}}}');

/***/ },

/***/ "./assets/src/blocks/awards-block/edit.js"
/*!************************************************!*\
  !*** ./assets/src/blocks/awards-block/edit.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const MAX_AWARDS = 40;
const createAwardId = () => `award-${Date.now().toString(36)}-${Math.random().toString(36).slice(2, 8)}`;
const createAward = () => ({
  ...DEFAULT_AWARD,
  id: createAwardId()
});
function Edit({
  ...
  const awardsWithImages = awards.filter(award => Boolean(award.imageUrl));
  ...
  const updateAward = (awardId, updates) => {
    setAttributes({
      awards: awards.map(award => award.id === awardId ? {
        ...award,
        ...updates
      } : award)
    });
  ...
  const moveAward = (awardId, direction) => {
    const currentIndex = awards.findIndex(award => award.id === awardId);
    const newIndex = currentIndex + direction;
    if (currentIndex < 0 || newIndex < 0 || newIndex >= awards.length) {
      return;
    }
    const nextAwards = [...awards];
    [nextAwards[currentIndex], nextAwards[newIndex]] = [nextAwards[newIndex], nextAwards[currentIndex]];
    setAttributes({
      awards: nextAwards
    });
  };
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Award Images', 'ambrygen-web'),
        initialOpen: false,
        children: [awards.map((award, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_4__.ItemHeader, {
            index: index,
            label: award.imageAlt || `Award ${index + 1}`,
            total: awards.length,
            onMove: (itemIndex, direction) => moveAward(awards[itemIndex].id, direction),
            onRemove: itemIndex => removeAward(awards[itemIndex].id),
            minCount: 1
            ...
            url: award.imageUrl,
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Award Image', 'ambrygen-web'),
            onSelect: media => {
        ...
        }, award.id)), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
          variant: "secondary",
          onClick: addAward,
          disabled: awards.length >= MAX_AWARDS,
          children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Award', 'ambrygen-web')
        })]
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Header Settings', 'ambrygen-web'),
        initialOpen: true,
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
          className: `awards-block__header block__rowflex is-${isHeaderVertical ? 'vertical' : 'horizontal'}`,
      ...
      }), hasAwards && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Fragment, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
            className: "marquee-slide__track",
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
              className: "marquee-slide__slider",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
                className: "marquee-slide__wrapper",
                children: awardsWithImages.map(award => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
...
/***/ "./assets/src/blocks/awards-block/editor.scss"
/*!****************************************************!*\
  !*** ./assets/src/blocks/awards-block/editor.scss ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./assets/src/blocks/awards-block/index.js"
/*!*************************************************!*\
  !*** ./assets/src/blocks/awards-block/index.js ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _shared_tooltip_format__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/tooltip-format */ "./assets/src/blocks/shared/tooltip-format.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/awards-block/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./assets/src/blocks/awards-block/editor.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/awards-block/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/awards-block/block.json");
...
/***/ "./assets/src/blocks/awards-block/style.scss"
/*!***************************************************!*\
  !*** ./assets/src/blocks/awards-block/style.scss ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 		var installedChunks = {
/******/ 			"awards-block/index": 0,
/******/ 			"awards-block/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["awards-block/style-index"], () => (__webpack_require__("./assets/src/blocks/awards-block/index.js")))
