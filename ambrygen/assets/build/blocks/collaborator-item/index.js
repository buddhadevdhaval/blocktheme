...
/***/ "./assets/src/blocks/collaborator-item/block.json"
/*!********************************************************!*\
  !*** ./assets/src/blocks/collaborator-item/block.json ***!
  \********************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/collaborator-item","title":"Collaborator Item","category":"ambrygen","icon":"networking","parent":["ambrygen/collaborators"],"attributes":{"termId":{"type":"number"}},"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","textdomain":"ambrygen-web","render":"file:./render.php","example":{"attributes":{"termId":1}}}');

/***/ },

/***/ "./assets/src/blocks/collaborator-item/edit.js"
/*!*****************************************************!*\
  !*** ./assets/src/blocks/collaborator-item/edit.js ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function Edit({
  ...
  const defaults = (0,_shared_components__WEBPACK_IMPORTED_MODULE_7__.DEFAULT_IMAGES)();
  const [searchResults, setSearchResults] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.useState)([]);
  const [isSearching, setIsSearching] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.useState)(false);
  const [searchInput, setSearchInput] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.useState)('');
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.useEffect)(() => {
    ...
    const timeoutId = setTimeout(async () => {
      setIsSearching(true);
      try {
        const fetchedTerms = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
          path: `/wp/v2/collaborator?context=edit&search=${encodeURIComponent(searchInput)}&per_page=20&orderby=name&order=asc`
        });
        if (isMounted) {
  ...
  const {
    ...
    return {
      selectedTerm: getEntityRecord('taxonomy', 'collaborator', termId),
      hasResolved: hasFinishedResolution('getEntityRecord', ['taxonomy', 'collaborator', termId])
    };
  }, [termId]);
  const selectedIds = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    const blockEditor = select('core/block-editor');
    const parentId = blockEditor.getBlockRootClientId(clientId);
    const siblings = blockEditor.getBlocks(parentId);
    return siblings.map(block => Number(block.attributes?.termId || 0)).filter(id => id > 0 && id !== Number(termId || 0));
  }, [clientId, termId]);
  const postTypeArchives = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    const {
      getPostType
    } = select('core');
    const postTypes = [{
      slug: 'publication',
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('View our Peer-Reviewed Publications', 'ambrygen-web')
    }, {
      slug: 'presentation',
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('View our Scientific Presentations', 'ambrygen-web')
    }, {
      slug: 'poster',
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('View our Scientific Posters', 'ambrygen-web')
    }];
  ...
  const imageUrl = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    ...
    const media = select('core').getMedia(selectedTerm.meta.term_image);
  ...
  const options = allAvailableTerms.filter(term => !selectedIds.includes(term.id)).map(term => ({
    label: (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_4__.decodeEntities)(term.name),
    value: String(term.id)
  }));
  const collaboratorName = selectedTerm?.name ? (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_4__.decodeEntities)(selectedTerm.name) : '';
  const collaboratorDescription = selectedTerm?.description ? (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_4__.decodeEntities)(selectedTerm.description) : '';
  const collaboratorWebsite = selectedTerm?.meta?.link ? selectedTerm.meta.link : '';
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
    ...
    children: [!hasResolved && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, {}), !termId && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ComboboxControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Select Collaborator', 'ambrygen-web'),
      value: "",
      options: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Search for a collaborator...', 'ambrygen-web'),
        value: ''
      }, ...options],
      ...
      help: (() => {
        if (isSearching) {
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, {}), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Searching...', 'ambrygen-web')]
          });
        }
        if (searchInput.length === 0) {
          return (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Type a name to search for collaborators...', 'ambrygen-web');
        }
        if (searchInput.length < 2) {
          return (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Please type at least 2 characters to search.', 'ambrygen-web');
        }
        return undefined;
      })(),
    ...
    }), termId && selectedTerm && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
        className: "timeline-block__badge-col collaborator-card__badge-col",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
          className: "timeline-block__badge"
        })
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
        className: "timeline-block__content-card collaborator-card__layout",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
          className: "timeline-block__image collaborator-card__media",
          ...
          className: "timeline-block__text-content collaborator-card__content",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
            className: "subtitle1-sbold mb-0 timeline-block__text-title collaborator-card__title",
            children: collaboratorName
          }), collaboratorDescription && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
              className: "is-style-gl-s12",
              "aria-hidden": "true"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
              className: "text-md-regular collaborator-card__description",
              children: collaboratorDescription
            })]
          }), postTypeArchives.length > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
              className: "is-style-gl-s12",
              "aria-hidden": "true"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("ul", {
              className: "collaborator-card__links",
              children: postTypeArchives.map(link => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("li", {
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
                  className: "",
          ...
          }), collaboratorWebsite && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
              className: "is-style-gl-s12",
              "aria-hidden": "true"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
              className: "collaborator-card__website",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
        ...
        className: "collaborator-card__actions actions-button",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
          ...
          children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Change Collaborator', 'ambrygen-web')
          ...
          children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Remove Collaborator', 'ambrygen-web')
        })]
      })]
    })]
  });
...
/***/ "./assets/src/blocks/collaborator-item/editor.scss"
/*!*********************************************************!*\
  !*** ./assets/src/blocks/collaborator-item/editor.scss ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./assets/src/blocks/collaborator-item/index.js"
/*!******************************************************!*\
  !*** ./assets/src/blocks/collaborator-item/index.js ***!
  \******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/collaborator-item/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/collaborator-item/edit.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/collaborator-item/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./assets/src/blocks/collaborator-item/editor.scss");
...
/***/ "./assets/src/blocks/collaborator-item/style.scss"
/*!********************************************************!*\
  !*** ./assets/src/blocks/collaborator-item/style.scss ***!
  \********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 		var installedChunks = {
/******/ 			"collaborator-item/index": 0,
/******/ 			"collaborator-item/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["collaborator-item/style-index"], () => (__webpack_require__("./assets/src/blocks/collaborator-item/index.js")))
