/******/ (() => { // webpackBootstrap
/*!******************************************************!*\
  !*** ./assets/src/blocks/collaborators-list/view.js ***!
  \******************************************************/
document.addEventListener('DOMContentLoaded', () => {
  ...
  containers.forEach(container => {
    ...
    const wrapper = container.querySelector('.collaborators-list__content-wrapper');
    if (!header || !wrapper) {
      return;
    }
    header.addEventListener('click', () => {
      ...
      container.setAttribute('data-amb-open', newOpen ? 'true' : 'false');
