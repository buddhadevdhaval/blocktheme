/******/ (() => { // webpackBootstrap
/*!*************************************************!*\
  !*** ./assets/src/blocks/counter-block/view.js ***!
  \*************************************************/
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const observer = new IntersectionObserver(entries => {
    entries.forEach(entry => {
      ...
      const numberElements = entry.target.querySelectorAll('.stats-counter__number');
  ...
  const statsCounters = document.querySelectorAll('.counter-block .stats-counter, .counter-block .intro__stats-wrapper');
