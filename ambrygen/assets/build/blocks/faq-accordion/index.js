...
/***/ "./assets/src/blocks/faq-accordion/block.json"
/*!****************************************************!*\
  !*** ./assets/src/blocks/faq-accordion/block.json ***!
  \****************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/faq-accordion","title":"FAQ Accordion","textdomain":"ambrygen-web","category":"ambrygen","icon":"editor-help","description":"Interactive FAQ accordion with image and expandable questions.","supports":{"html":false,"anchor":true},"providesContext":{"ambrygen/faqAccordionVariant":"variant"},"attributes":{"blockId":{"type":"string","default":""},"title":{"type":"string","default":""},"description":{"type":"string","default":""},"headingTag":{"type":"string","default":"h5","enum":["h1","h2","h3","h4","h5","h6"]},"variant":{"type":"string","default":"default","enum":["default","without-image"]},"imageUrl":{"type":"string"},"imageId":{"type":"number","default":0},"imageAlt":{"type":"string","default":""},"faqs":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"question":{"type":"string"},"subHeading":{"type":"string"},"answer":{"type":"string"},"items":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"text":{"type":"string"}}}}}},"default":[{"id":"","question":"","subHeading":"","answer":""},{"id":"","question":"","subHeading":"","answer":""}]}},"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js","render":"file:./render.php","example":{"attributes":{"blockId":"faq-accordion-example"}}}');

/***/ },

/***/ "./assets/src/blocks/faq-accordion/edit.js"
/*!*************************************************!*\
  !*** ./assets/src/blocks/faq-accordion/edit.js ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const createParagraphBlock = (content = '') => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('core/paragraph', {
  content
});
...
const createFaqItemBlock = (faq = {}) => {
  ...
  if (Array.isArray(faq?.items) && faq.items.length) {
    innerBlocks.push((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('core/list', {
  ...
  return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('ambrygen/faq-accordion-item', {
...
function Edit({
  ...
  const variantClassName = variant === 'without-image' ? `variation-${variant} variation-boxed` : `variation-${variant}`;
  const {
    insertBlock,
    replaceInnerBlocks
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useDispatch)('core/block-editor');
  const hasInnerBlocks = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => select('core/block-editor').getBlockCount(clientId) > 0, [clientId]);
  const hasDescription = Boolean(description);
  const hasFaqContent = hasInnerBlocks || faqs.length > 0;
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
    className: `block-layout alongside-faq ${variantClassName}`
  });
  const defaultImage = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useMemo)(() => (0,_shared_components__WEBPACK_IMPORTED_MODULE_6__.DEFAULT_IMAGES)()?.placeholder || {}, []);
  const displayImageUrl = imageUrl || defaultImage.url || '';
  const isDefaultImage = imageUrl === defaultImage.url && imageId === defaultImage.id;
  const variants = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useMemo)(() => [{
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('With Image View', 'ambrygen-web'),
    value: FAQ_VARIANTS.WITH_IMAGE,
    image: (0,_utils_assets__WEBPACK_IMPORTED_MODULE_7__.getThemeAssetUrl)('/assets/src/images/faq-accordion/withimage.png')
  }, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Normal View', 'ambrygen-web'),
    value: FAQ_VARIANTS.NORMAL,
    image: (0,_utils_assets__WEBPACK_IMPORTED_MODULE_7__.getThemeAssetUrl)('/assets/src/images/faq-accordion/without-image.png')
  }], []);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Layout Settings', 'ambrygen-web'),
        initialOpen: true,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
          className: "layout-variant-selector",
          children: variants.map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("button", {
            type: "button",
            className: `variant-button ${variant === item.value ? 'is-selected' : ''}`,
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('FAQ Settings', 'ambrygen-web'),
        children: showImage && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_6__.ImageUploader, {
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('FAQ Image', 'ambrygen-web'),
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
        className: "alongside-faq__row",
        children: [showImage && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
          className: "alongside-faq__col alongside-faq__col--left",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
            className: "alongside-faq__media",
            children: displayImageUrl && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("img", {
              src: displayImageUrl,
              alt: imageAlt || ''
            })
          })
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
          className: `alongside-faq__col alongside-faq__col--right ${showImage ? '' : 'full-width'}`,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
            className: "alongside-faq__content",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
            ...
            }), hasDescription && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
            ...
            }), hasFaqContent && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InnerBlocks, {
                allowedBlocks: ['ambrygen/faq-accordion-item'],
                template: TEMPLATE,
                templateLock: false,
                ...
                variant: "primary",
                onClick: () => {
                  insertBlock((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('ambrygen/faq-accordion-item'), undefined, clientId);
                },
                children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Add FAQ Accordion Item', 'ambrygen-web')
              })]
            })]
          })
        })]
...
/***/ "./assets/src/blocks/faq-accordion/editor.scss"
/*!*****************************************************!*\
  !*** ./assets/src/blocks/faq-accordion/editor.scss ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./assets/src/blocks/faq-accordion/index.js"
/*!**************************************************!*\
  !*** ./assets/src/blocks/faq-accordion/index.js ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/faq-accordion/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./assets/src/blocks/faq-accordion/editor.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/faq-accordion/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/faq-accordion/block.json");
...
/***/ "./assets/src/blocks/faq-accordion/style.scss"
/*!****************************************************!*\
  !*** ./assets/src/blocks/faq-accordion/style.scss ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["faq-accordion/style-index"], () => (__webpack_require__("./assets/src/blocks/faq-accordion/index.js")))
