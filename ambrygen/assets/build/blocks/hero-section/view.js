...
(() => {
/*!************************************************!*\
  !*** ./assets/src/blocks/hero-section/view.js ***!
  \************************************************/
__webpack_require__.r(__webpack_exports__);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  sliders.forEach(sliderElement => {
    ...
    const autoplayToggle = sliderElement.querySelector('[data-hero-autoplay-toggle]');
    const slideCount = sliderElement.querySelectorAll('.swiper-slide').length;
    const announcerElement = sliderElement.querySelector('[data-slide-announcer]');
    let shouldManageFocus = false;
    const updateSlideAnnouncer = swiperInstance => {
      if (!announcerElement || !swiperInstance || slideCount < 1) {
        return;
      }
      announcerElement.textContent = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)(/* translators: 1: Current slide number, 2: Total slides. */
      (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Slide %1$d of %2$d', 'ambrygen-web'), swiperInstance.realIndex + 1, slideCount);
    };
    ...
    const updateAutoplayToggle = isPaused => {
      ...
      autoplayToggle.setAttribute('aria-label', isPaused ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Start autoplay', 'ambrygen-web') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Pause autoplay', 'ambrygen-web'));
    };
    const manageSlideFocus = swiperInstance => {
      ...
      if (!activeElement || document.body === activeElement || !sliderElement.contains(activeElement)) {
    ...
    sliderElement.addEventListener('keydown', event => {
      if ('ArrowLeft' === event.key || 'ArrowRight' === event.key || 'Enter' === event.key || ' ' === event.key) {
    ...
    const swiperOptions = {
      ...
      navigation: config.navigation && nextEl && prevEl ? {
        nextEl,
        prevEl
      } : false,
      pagination: config.pagination && paginationEl ? {
        ...
        renderBullet(index, className) {
          ...
          bullet.setAttribute('aria-label', (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)(/* translators: %d: Slide number. */
          (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Go to slide %d', 'ambrygen-web'), index + 1));
    ...
    swiperInstance = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](sliderElement, swiperOptions);
  });
});
})();
