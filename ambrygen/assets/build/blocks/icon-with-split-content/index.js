...
/***/ "./assets/src/blocks/icon-with-split-content/block.json"
/*!**************************************************************!*\
  !*** ./assets/src/blocks/icon-with-split-content/block.json ***!
  \**************************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/icon-with-split-content","title":"Icon with Split Content","category":"ambrygen","icon":"grid-view","description":"A two-column block with an icon grid on the left and content on the right.","textdomain":"ambrygen-web","supports":{"html":false,"anchor":true,"align":["wide","full"],"spacing":{"margin":true,"padding":true}},"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","attributes":{"heading":{"type":"string","default":""},"headingTag":{"type":"string","enum":["h1","h2","h3","h4","h5","h6"],"default":"h2"},"description":{"type":"string","default":""},"items":{"type":"array","default":[],"items":{"type":"object","properties":{"id":{"type":"string"},"iconId":{"type":"number"},"iconUrl":{"type":"string"},"iconAlt":{"type":"string"},"text":{"type":"string"}}}},"blockId":{"type":"string","default":""}},"example":{"attributes":{"blockId":"icon-with-split-content-example"}}}');

/***/ },

/***/ "./assets/src/blocks/icon-with-split-content/edit.js"
/*!***********************************************************!*\
  !*** ./assets/src/blocks/icon-with-split-content/edit.js ***!
  \***********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function createItemId() {
  return `icon-item-${Date.now()}-${Math.random().toString(36).slice(2, 10)}`;
}
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Repeater', 'ambrygen-web'),
        initialOpen: false,
        children: [items.map((item, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_4__.ItemHeader, {
            index: index,
            label: sanitizePlainText(item.text || '') || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Title', 'ambrygen-web'),
            total: items.length,
            onMove: moveItem,
            onRemove: removeItem,
            minCount: 0
            ...
            url: item.iconUrl,
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('ICON', 'ambrygen-web'),
            onSelect: media => {
              updateItem(item.id, {
                iconId: media.id || 0,
                iconUrl: media.url || '',
        ...
        }, item.id)), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
          variant: "secondary",
          onClick: addItem,
          children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Item', 'ambrygen-web')
        })]
      })]
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
      ...blockProps,
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
        className: "symptoms__grid",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
          className: "symptoms__left",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Notice, {
            status: "info",
            isDismissible: false,
            children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add each icon image from the left-side repeater settings panel.', 'ambrygen-web')
          }), items.map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
            className: "symptoms__item",
            children: [item.iconUrl && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("img", {
              src: item.iconUrl,
              alt: item.iconAlt || '',
              className: "symptoms__icon"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
              className: "symptoms__text",
              children: sanitizePlainText(item.text || '') || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Title', 'ambrygen-web')
            })]
          }, item.id))]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
          className: "symptoms__right",
          ...
          }), hasHeading && hasDescription && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
...
/***/ "./assets/src/blocks/icon-with-split-content/index.js"
/*!************************************************************!*\
  !*** ./assets/src/blocks/icon-with-split-content/index.js ***!
  \************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/icon-with-split-content/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/icon-with-split-content/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/icon-with-split-content/block.json");
...
/***/ "./assets/src/blocks/icon-with-split-content/style.scss"
/*!**************************************************************!*\
  !*** ./assets/src/blocks/icon-with-split-content/style.scss ***!
  \**************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 		var installedChunks = {
/******/ 			"icon-with-split-content/index": 0,
/******/ 			"icon-with-split-content/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["icon-with-split-content/style-index"], () => (__webpack_require__("./assets/src/blocks/icon-with-split-content/index.js")))
