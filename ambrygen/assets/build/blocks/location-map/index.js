...
/***/ "./assets/src/blocks/location-map/block.json"
/*!***************************************************!*\
  !*** ./assets/src/blocks/location-map/block.json ***!
  \***************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/location-map","title":"Location Map","textdomain":"ambrygen-web","category":"ambrygen","icon":"location-alt","description":"Block with Google Maps and location list","supports":{"html":false},"attributes":{"blockId":{"type":"string","default":""},"title":{"type":"string","default":""},"iframe":{"type":"string","default":""},"locations":{"type":"array","default":[{"id":"","name":"","address":""},{"id":"","name":"","address":""}],"items":{"type":"object","properties":{"id":{"type":"string"},"name":{"type":"string"},"address":{"type":"string"}}}},"headingLevel":{"type":"string","enum":["h1","h2","h3","h4","h5","h6"],"default":"h2"}},"render":"file:./render.php","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","example":{"attributes":{"title":"Our Locations","iframe":"https://www.google.com/maps/embed?pb=example","locations":[{"id":"loc-headquarters","name":"Headquarters","address":"1 Enterprise, Aliso Viejo, CA 92656"},{"id":"loc-lab","name":"Lab (For specimen shipments)","address":"7 Argonaut, Aliso Viejo, CA 92656"}],"headingLevel":"h2"}}}');

/***/ },

/***/ "./assets/src/blocks/location-map/edit.js"
/*!************************************************!*\
  !*** ./assets/src/blocks/location-map/edit.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const createLocationMapItemId = () => `loc-${Date.now()}-${Math.random().toString(36).slice(2, 9)}`;
const DEFAULT_LOCATIONS = [{
  id: createLocationMapItemId(),
  name: '',
  address: ''
}, {
  id: createLocationMapItemId(),
...
const isAllowedMapUrl = value => {
  ...
  try {
    ...
    return url.protocol === 'https:' && ['www.google.com', 'google.com', 'maps.google.com'].includes(host) && url.pathname.startsWith('/maps/embed');
  } catch (error) {
    return false;
  }
};
function Edit({
  ...
  const onChangeLocationMapTitle = value => setAttributes({
    title: value
  });
  ...
  const updateLocationMapItem = (id, key, value) => {
    setAttributes({
      locations: locations.map(loc => loc.id === id ? {
        ...loc,
        [key]: value
      } : loc)
    });
  ...
  const moveLocationMapItem = (id, direction) => {
    ...
    if (currentIndex < 0 || nextIndex < 0 || nextIndex >= locations.length) {
      return;
    }
    const updatedLocations = [...locations];
    [updatedLocations[currentIndex], updatedLocations[nextIndex]] = [updatedLocations[nextIndex], updatedLocations[currentIndex]];
    setAttributes({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Map Settings', 'ambrygen-web'),
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelRow, {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Iframe', 'ambrygen-web'),
            value: iframe || '',
            help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Paste an https:// Google Maps embed URL or full iframe embed code.', 'ambrygen-web'),
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Locations', 'ambrygen-web'),
        initialOpen: true,
        children: [locations.map((loc, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_4__.ItemHeader, {
            ...
            prefix: "LOCATION",
            onMove: (itemIndex, dir) => moveLocationMapItem(locations[itemIndex].id, dir),
            onRemove: itemIndex => removeLocationMapItem(locations[itemIndex].id),
            minCount: 1
            ...
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Title', 'ambrygen-web'),
            value: loc.name,
            onChange: value => updateLocationMapItem(loc.id, 'name', value)
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Address', 'ambrygen-web'),
            value: loc.address,
            onChange: value => updateLocationMapItem(loc.id, 'address', value)
          })]
        }, loc.id)), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
          variant: "primary",
          onClick: addLocationMapItem,
          children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Add Location', 'ambrygen-web')
        })]
      })]
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
      className: "location-map__row",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
        className: "location-map__media",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
          className: "location-map__image",
          children: iframeSrc ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("iframe", {
            src: iframeSrc,
            width: "100%",
            height: "300",
            title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Google Map Preview', 'ambrygen-web'),
            loading: "lazy",
            allowFullScreen: true
          }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
            className: "location-map__placeholder",
            children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('No Map URL Set', 'ambrygen-web')
          })
        })
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
        className: "location-map__content",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText, {
          ...
          className: "location-map__text",
          children: locations.map(loc => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
            className: "location-list",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
              className: "location-title text-xl-semibold",
              children: loc.name || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Add Title...', 'ambrygen-web')
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
              className: "location-description text-medium",
              children: loc.address || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Add Address...', 'ambrygen-web')
            }), loc.address && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
              className: "is-style-gl-s24",
              "aria-hidden": "true"
            })]
          }, loc.id))
...
/***/ "./assets/src/blocks/location-map/index.js"
/*!*************************************************!*\
  !*** ./assets/src/blocks/location-map/index.js ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/location-map/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/location-map/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/location-map/block.json");
/**
...
/***/ "./assets/src/blocks/location-map/style.scss"
/*!***************************************************!*\
  !*** ./assets/src/blocks/location-map/style.scss ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["location-map/style-index"], () => (__webpack_require__("./assets/src/blocks/location-map/index.js")))
