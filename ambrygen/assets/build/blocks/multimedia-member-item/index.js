...
/***/ "./assets/src/blocks/multimedia-member-item/block.json"
/*!*************************************************************!*\
  !*** ./assets/src/blocks/multimedia-member-item/block.json ***!
  \*************************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/multimedia-member-item","title":"Multimedia Member Item","category":"ambrygen","icon":"format-image","parent":["ambrygen/multimedia-member"],"supports":{"html":false},"attributes":{"postId":{"type":"number","default":0}},"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","textdomain":"ambrygen-web","viewScript":"file:./view.js","render":"file:./render.php"}');

/***/ },

/***/ "./assets/src/blocks/multimedia-member-item/edit.js"
/*!**********************************************************!*\
  !*** ./assets/src/blocks/multimedia-member-item/edit.js ***!
  \**********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const getUrlFromUnknown = value => {
  ...
  if (value && typeof value === 'object') {
    return value.url || value.source_url || value.full_url || value?.sizes?.full?.url || '';
  }
  return '';
};
const normalizeMemberMediaMeta = metaValue => {
  ...
  if (typeof parsed === 'string') {
    ...
    if (/^\d+(\s*,\s*\d+)+$/.test(trimmed)) {
      ...
      parsed = trimmed.split(',').map(item => item.trim()).filter(item => /^\d+$/.test(item));
...
function Edit({
  ...
  const defaults = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useMemo)(() => (0,_shared_components__WEBPACK_IMPORTED_MODULE_3__.DEFAULT_IMAGES)(), []);
  ...
  const memberMediaItems = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useMemo)(() => normalizeMemberMediaMeta(selectedPost?.meta?.image_gallry || selectedPost?.meta?.image_gallary), [selectedPost?.meta?.image_gallry, selectedPost?.meta?.image_gallary]);
  const memberMediaIds = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useMemo)(() => memberMediaItems.map(item => item.imageId).filter(Boolean), [memberMediaItems]);
  const resolution = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
    const {
      getMedia
    } = select('core');
  ...
  const finalMemberMedia = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useMemo)(() => {
    if (memberMediaItems.length > 0) {
      const keyCounts = new Map();
      return memberMediaItems.map((item, index) => {
        const media = resolution[index];
        const url = item.imageUrl || media?.source_url || media?.sizes?.full?.url || '';
        const alt = media?.alt_text || media?.title?.rendered || '';
        if (!url) {
          return null;
        }
        const keyBase = item.imageId ? `id-${item.imageId}` : `url-${url}`;
        const nextCount = (keyCounts.get(keyBase) || 0) + 1;
        keyCounts.set(keyBase, nextCount);
        return {
          key: nextCount === 1 ? keyBase : `${keyBase}-${nextCount}`,
          url,
          alt: (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_6__.decodeEntities)(alt)
        };
      }).filter(Boolean);
    }
    ...
    const fallbackAlt = selectedPost?._embedded?.['wp:featuredmedia']?.[0]?.alt_text;
    return [{
      key: 'fallback-image',
      url: fallbackUrl,
      alt: (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_6__.decodeEntities)(fallbackAlt || '')
    }];
  }, [memberMediaItems, resolution, featuredMediaUrl, defaults, selectedPost]);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
    ...(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useBlockProps)({
      className: 'multimedia-member__item'
    }),
    children: [postId && !selectedPost && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Spinner, {}), !postId && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("p", {
      children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Select members from the Multimedia Member block settings.', 'ambrygen-web')
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
          className: "multimedia-member-item__media-slider swiper",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
            className: "swiper-wrapper",
            children: finalMemberMedia.map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
          ...
          }), shouldShowNavigation && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
            className: "swiper-buttons",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("button", {
              type: "button",
              className: "custom-prev",
              "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Previous Slide', 'ambrygen-web')
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("button", {
              type: "button",
              className: "custom-next",
              "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Next Slide', 'ambrygen-web')
            })]
          })]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
          className: "multimedia-member__overlay",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
            className: "multimedia-member__title heading-5 mb-0",
            children: (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_6__.decodeEntities)(selectedPost.title.rendered)
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
            className: "is-style-gl-s10",
            "aria-hidden": "true"
          }), selectedPost.meta?.designation && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("span", {
            className: "multimedia-member__role subtitle2",
            children: (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_6__.decodeEntities)(selectedPost.meta?.designation || '')
          })]
        })]
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
          className: "multimedia-member__meta body2-reg",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("strong", {
            children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Admin Settings', 'ambrygen-web')
          }), ' ', "( ", memberMediaItems.length, ' ', (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('media items total', 'ambrygen-web'), " )"]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
            ...
            children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Remove Member', 'ambrygen-web')
          })
        })]
      })]
    })]
...
/***/ "./assets/src/blocks/multimedia-member-item/editor.scss"
/*!**************************************************************!*\
  !*** ./assets/src/blocks/multimedia-member-item/editor.scss ***!
  \**************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./assets/src/blocks/multimedia-member-item/index.js"
/*!***********************************************************!*\
  !*** ./assets/src/blocks/multimedia-member-item/index.js ***!
  \***********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/multimedia-member-item/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./assets/src/blocks/multimedia-member-item/editor.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/multimedia-member-item/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/multimedia-member-item/block.json");
...
/***/ "./assets/src/blocks/multimedia-member-item/style.scss"
/*!*************************************************************!*\
  !*** ./assets/src/blocks/multimedia-member-item/style.scss ***!
  \*************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 		var installedChunks = {
/******/ 			"multimedia-member-item/index": 0,
/******/ 			"multimedia-member-item/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["multimedia-member-item/style-index"], () => (__webpack_require__("./assets/src/blocks/multimedia-member-item/index.js")))
