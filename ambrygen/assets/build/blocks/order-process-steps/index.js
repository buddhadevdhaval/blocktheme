...
/***/ "./assets/src/blocks/order-process-steps/block.json"
/*!**********************************************************!*\
  !*** ./assets/src/blocks/order-process-steps/block.json ***!
  \**********************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/order-process-steps","title":"Order Process Steps","category":"ambrygen","icon":"list-view","description":"Displays a step-by-step order process section.","supports":{"html":false},"attributes":{"blockId":{"type":"string","default":""},"headingTag":{"type":"string","enum":["h1","h2","h3","h4","h5","h6"],"default":"h2"},"headingText":{"type":"string","default":""},"subtitle":{"type":"string","default":""},"steps":{"type":"array","default":[],"items":{"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"description":{"type":"string"},"iconUrl":{"type":"string"},"iconId":{"type":"number"},"iconAlt":{"type":"string"}}}}},"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","textdomain":"ambrygen-web","example":{"attributes":{"blockId":"order-process-steps-example"}}}');

/***/ },

/***/ "./assets/src/blocks/order-process-steps/edit.js"
/*!*******************************************************!*\
  !*** ./assets/src/blocks/order-process-steps/edit.js ***!
  \*******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const createStepId = () => `step-${Date.now().toString(36)}-${Math.random().toString(36).slice(2, 8)}`;
const createStep = () => ({
  id: createStepId(),
  title: '',
  description: '',
...
function Edit({
  ...
  const removeStep = stepId => {
    ...
    setAttributes({
      steps: normalizeSteps(steps.filter(step => step.id !== stepId))
    });
  };
  const updateStepImage = (stepId, media) => {
    ...
    setAttributes({
      steps: normalizeSteps(steps.map(currentStep => currentStep.id === stepId ? {
        ...currentStep,
        iconUrl: media.url,
        iconId: media.id || 0,
  ...
  const moveStep = (stepId, direction) => {
    ...
    [updatedSteps[currentIndex], updatedSteps[nextIndex]] = [updatedSteps[nextIndex], updatedSteps[currentIndex]];
    setAttributes({
      steps: normalizeSteps(updatedSteps)
    });
  };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Steps', 'ambrygen-web'),
        initialOpen: true,
        children: [steps.map((step, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_4__.ItemHeader, {
            ...
            total: steps.length,
            prefix: "STEP",
            onMove: (i, dir) => moveStep(steps[i].id, dir),
            ...
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Step Icon', 'ambrygen-web'),
            url: step.iconUrl || '',
            onSelect: media => updateStepImage(step.id, media),
            onRemove: () => removeStepImage(step.id)
          })]
        }, step.id)), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
          variant: "primary",
          onClick: addStep,
          className: "order-process-steps__add-step",
          children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add New Step', 'ambrygen-web')
        })]
      })]
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
      ...blockProps,
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
        className: "order-process-steps__header",
        ...
        className: "order-process-steps__steps",
        children: steps.map((step, index) => {
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
            className: "order-process-steps__step",
            children: [step.iconUrl && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
              className: "order-process-steps__step-icon",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("img", {
                src: step.iconUrl,
                alt: step.iconAlt || ''
              })
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
              className: "order-process-steps__step-content",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
                className: "body2-semibold order-process-steps__step-number",
                ...
                placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Step Title', 'ambrygen-web')
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
                tagName: "div",
                className: "body1 order-process-steps__step-desc",
                value: step.description || '',
                onChange: value => updateStep(step.id, 'description', value),
                placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Step Description', 'ambrygen-web')
              })]
            })]
          }, step.id);
        })
...
/***/ "./assets/src/blocks/order-process-steps/editor.scss"
/*!***********************************************************!*\
  !*** ./assets/src/blocks/order-process-steps/editor.scss ***!
  \***********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./assets/src/blocks/order-process-steps/index.js"
/*!********************************************************!*\
  !*** ./assets/src/blocks/order-process-steps/index.js ***!
  \********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/order-process-steps/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./assets/src/blocks/order-process-steps/editor.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/order-process-steps/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/order-process-steps/block.json");
...
/***/ "./assets/src/blocks/order-process-steps/style.scss"
/*!**********************************************************!*\
  !*** ./assets/src/blocks/order-process-steps/style.scss ***!
  \**********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 		var installedChunks = {
/******/ 			"order-process-steps/index": 0,
/******/ 			"order-process-steps/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["order-process-steps/style-index"], () => (__webpack_require__("./assets/src/blocks/order-process-steps/index.js")))
