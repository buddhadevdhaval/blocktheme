...
/***/ "./assets/src/blocks/our-team-item/block.json"
/*!****************************************************!*\
  !*** ./assets/src/blocks/our-team-item/block.json ***!
  \****************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/our-team-item","title":"Team Member","category":"ambrygen","icon":"id","parent":["ambrygen/our-team"],"usesContext":["ambrygen/ourTeamVariation","ambrygen/ourTeamBlockId"],"attributes":{"postId":{"type":"number","default":0}},"supports":{"html":false},"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","textdomain":"ambrygen-web","render":"file:./render.php","example":{"attributes":{"postId":1}}}');

/***/ },

/***/ "./assets/src/blocks/our-team-item/edit.js"
/*!*************************************************!*\
  !*** ./assets/src/blocks/our-team-item/edit.js ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function Edit({
  ...
  const defaults = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useMemo)(() => (0,_shared_components__WEBPACK_IMPORTED_MODULE_6__.DEFAULT_IMAGES)(), []);
  const hasSelectedPost = Boolean(selectedPostId);
  const parentVariation = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
    const blockEditor = select('core/block-editor');
    const parentId = blockEditor.getBlockRootClientId(clientId);
    const parentBlock = parentId ? blockEditor.getBlock(parentId) : null;
  ...
  const selectedPost = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
    ...
    const teamPost = select('core').getEntityRecord('postType', 'author', selectedPostId);
    if (teamPost) {
      return teamPost;
    }
    return null;
  ...
  const media = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
    ...
    return select('core').getEntityRecord('postType', 'attachment', featuredMediaId);
  }, [featuredMediaId]);
  ...
  const options = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useMemo)(() => {
    ...
    return teamMembers.map(post => ({
      label: (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_4__.decodeEntities)(post?.title?.rendered || post?.title?.raw || ''),
      value: post.id
    }));
  }, [teamMembers]);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.InspectorControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Team Member Settings', 'ambrygen-web'),
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ComboboxControl, {
          label: hasSelectedPost ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Change Member', 'ambrygen-web') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Select Member', 'ambrygen-web'),
          ...
          help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Search by name to find a team member.', 'ambrygen-web')
        }), hasSelectedPost && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
          isDestructive: true,
          variant: "secondary",
          onClick: () => removeBlock(clientId),
          children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Remove Member', 'ambrygen-web')
        })]
      })
    }), !hasSelectedPost && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
      className: "our-team__selection-placeholder",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ComboboxControl, {
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Search Team Member', 'ambrygen-web'),
        value: "",
        options: options,
        onFilterValueChange: value => setSearchInput(value),
        onChange: value => setAttributes({
      ...
      }), !teamMembers && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Spinner, {})]
    }), hasSelectedPost && selectedPost && (() => {
      const imageUrl = media?.source_url || defaults?.placeholder?.url;
      const designation = selectedPost.meta?.user_designation || selectedPost.meta?.designation || '';
      const cardContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
          className: `${classPrefix}__image-wrapper`,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("img", {
            src: imageUrl,
            alt: (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_4__.decodeEntities)(selectedPost.title.rendered),
            className: `${classPrefix}__image`
          })
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
          className: `${classPrefix}__info`,
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
            className: `${classPrefix}__name subtitle1-sbold`,
            children: [(0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_4__.decodeEntities)(selectedPost.title.rendered), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
              className: `${classPrefix}__link`
            })]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
            className: `${classPrefix}__role ${isSliderView ? 'subtitle2' : 'body1'}`,
            children: designation
          })]
        })]
      });
      return isSliderView ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
        className: "our-leadership__card",
...
(() => {
/*!**************************************************!*\
  !*** ./assets/src/blocks/our-team-item/index.js ***!
  \**************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/our-team-item/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/our-team-item/block.json");
