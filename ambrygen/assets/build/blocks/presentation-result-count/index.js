...
/***/ "./assets/src/blocks/presentation-result-count/block.json"
/*!****************************************************************!*\
  !*** ./assets/src/blocks/presentation-result-count/block.json ***!
  \****************************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/presentation-result-count","version":"1.0.0","title":"Presentation Result Count","category":"ambrygen","description":"Renders presentation result count.","attributes":{"previewPostId":{"type":"number","default":0}},"usesContext":["postId","postType"],"supports":{"html":false,"reusable":false},"editorScript":"file:./index.js","render":"file:./render.php","textdomain":"ambrygen-web"}');

/***/ },

/***/ "./assets/src/blocks/presentation-result-count/edit.js"
/*!*************************************************************!*\
  !*** ./assets/src/blocks/presentation-result-count/edit.js ***!
  \*************************************************************/
...
/***/ "./assets/src/blocks/presentation-result-count/save.js"
/*!*************************************************************!*\
  !*** ./assets/src/blocks/presentation-result-count/save.js ***!
  \*************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(() => {
/*!**************************************************************!*\
  !*** ./assets/src/blocks/presentation-result-count/index.js ***!
  \**************************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/presentation-result-count/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/presentation-result-count/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./save */ "./assets/src/blocks/presentation-result-count/save.js");
...
const unsubscribe = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.subscribe)(() => {
  ...
  if (postType && postType !== 'presentation') {
