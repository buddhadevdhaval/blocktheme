...
/***/ "./assets/src/blocks/quiz-block/block.json"
/*!*************************************************!*\
  !*** ./assets/src/blocks/quiz-block/block.json ***!
  \*************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/quiz-block","title":"Quiz Block","category":"ambrygen","icon":"forms","description":"Interactive hereditary cancer risk checklist with dynamic result messaging and CTA buttons.","textdomain":"ambrygen-web","supports":{"html":false,"align":["wide","full"],"spacing":{"margin":true,"padding":true}},"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js","attributes":{"blockId":{"type":"string"},"eyebrowText":{"type":"string"},"heading":{"type":"string"},"headingTag":{"type":"string","enum":["h1","h2","h3","h4","h5","h6"]},"cardTitle":{"type":"string"},"cardSubtitle":{"type":"string"},"checklistItems":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"text":{"type":"string"}}}},"noRiskText":{"type":"string"},"atRiskText":{"type":"string"},"buttons":{"type":"array","items":{"type":"object","properties":{"text":{"type":"string"},"url":{"type":"string"},"target":{"type":"string"},"rel":{"type":"string"},"variant":{"type":"string"}}}}},"example":{"attributes":{"blockId":"quiz-block-example"}}}');

/***/ },

/***/ "./assets/src/blocks/quiz-block/edit.js"
/*!**********************************************!*\
  !*** ./assets/src/blocks/quiz-block/edit.js ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const createChecklistId = () => `risk-item-${Date.now().toString(36)}-${Math.random().toString(36).slice(2, 8)}`;
...
const getFieldButtonValue = (button = {}) => ({
  ...button,
  variant: button.variant === 'site-btn is-style-site-tertiary-btn has-right-arrow' ? 'is-style-site-tertiary-btn' : 'dark'
});
...
const hasButtonPreviewValue = (button = {}) => Object.values(button).some(value => Boolean(value));
function Edit({
  attributes,
  setAttributes,
  clientId
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    if (blockId !== 'quiz-block-example' && (!blockId || !blockId.endsWith(clientIdSuffix))) {
      setAttributes({
        blockId: expectedId
      });
    }
  ...
  if (blockId === 'quiz-block-example') {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_5__.BlockExamplePreview, {
  ...
  const updateChecklistItem = (itemId, value) => {
    setAttributes({
      checklistItems: checklistItems.map(item => item.id === itemId ? {
        ...item,
        text: value
      } : item)
    });
  ...
  const ctaButtons = [{
    ...
    fallbackText: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Button 1', 'ambrygen-web')
  }, {
    key: 'secondary',
    button: secondaryButton,
    fallbackText: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Button 2', 'ambrygen-web')
  }];
  const hasButtons = ctaButtons.some(({
    button
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Button Settings', 'ambrygen-web'),
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
          ...
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Primary Button', 'ambrygen-web'),
          value: getFieldButtonValue(primaryButton),
          onChange: value => setAttributes({
            buttons: [getStoredButtonValue(value, 'site-btn'), secondaryButton]
          }),
          textLabel: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Text', 'ambrygen-web')
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
          className: "is-style-gl-s16",
          "aria-hidden": "true"
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_5__.CtaButtonField, {
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Secondary Button', 'ambrygen-web'),
          value: getFieldButtonValue(secondaryButton),
          onChange: value => setAttributes({
            buttons: [primaryButton, getStoredButtonValue(value, 'site-btn is-style-site-tertiary-btn has-right-arrow')]
          }),
          textLabel: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Text', 'ambrygen-web')
        })]
      })]
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
        className: "risk-checklist__header",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
          ...
          placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Eyebrow…', 'ambrygen-web')
        }), hasEyebrowText && hasHeading && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
        ...
        className: "risk-checklist__card",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
          className: "risk-checklist__card-header",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
            tagName: "h3",
            ...
            placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Card Title…', 'ambrygen-web')
          }), hasCardTitle && hasCardSubtitle && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
            ...
            placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Card Short Description…', 'ambrygen-web')
          })]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
          className: "risk-checklist__card-body",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
            className: "risk-checklist__actions",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
              ...
              children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Checklist Item', 'ambrygen-web')
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
              className: "is-style-gl-s32",
              "aria-hidden": "true"
            })]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
            className: "risk-checklist__items",
            children: checklistItems.map((item, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
              className: "risk-checklist__item",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
                className: "risk-checklist__item-toolbar",
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
                  className: "subtitle2-sbold risk-checklist__item-toolbar-title",
                ...
                className: "risk-checklist__item-label",
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("input", {
                  ...
                  placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Checklist Item Text', 'ambrygen-web')
                })]
              })]
            }, item.id))
          }), (hasNoRiskText || hasAtRiskText) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
            className: "is-style-gl-s24",
            "aria-hidden": "true"
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
            className: "risk-checklist__result risk-checklist__result--no-risk",
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
              tagName: "p",
              ...
              placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Instructions…', 'ambrygen-web')
            })
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
            className: "is-style-gl-s24",
            "aria-hidden": "true"
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
            className: "risk-checklist__result risk-checklist__result--at-risk",
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
              tagName: "p",
              className: "body1 risk-checklist__result-text",
              value: atRiskText,
              ...
              placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Risk Instructions…', 'ambrygen-web')
            })
          })]
        })]
      }), hasButtons && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
        className: "is-style-gl-s32",
        "aria-hidden": "true"
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
        className: "risk-checklist__cta",
        children: ctaButtons.map(({
          key,
          button,
          fallbackText
        }) => hasButtonPreviewValue(button) ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("a", {
          ...getButtonPreviewProps(button),
          children: button.text || fallbackText
        }, key) : null)
      })]
    })]
  });
...
/***/ "./assets/src/blocks/quiz-block/index.js"
/*!***********************************************!*\
  !*** ./assets/src/blocks/quiz-block/index.js ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/quiz-block/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/quiz-block/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/quiz-block/block.json");
...
/***/ "./assets/src/blocks/quiz-block/style.scss"
/*!*************************************************!*\
  !*** ./assets/src/blocks/quiz-block/style.scss ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["quiz-block/style-index"], () => (__webpack_require__("./assets/src/blocks/quiz-block/index.js")))
