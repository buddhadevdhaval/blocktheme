...
/***/ "./assets/src/blocks/resources/block.json"
/*!************************************************!*\
  !*** ./assets/src/blocks/resources/block.json ***!
  \************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/resources","title":"Resources","category":"ambrygen","icon":"index-card","description":"A block to display resource cards and organization logos.","textdomain":"ambrygen-web","supports":{"html":false,"align":["wide","full"],"spacing":{"margin":true,"padding":true}},"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","attributes":{"blockId":{"type":"string","default":""},"title":{"type":"string","default":""},"subtitle":{"type":"string","default":""},"resourceCards":{"type":"array","default":[],"items":{"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"pdfLinks":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"label":{"type":"string"},"url":{"type":"string"}}}}}}},"orgTitle":{"type":"string","default":""},"collaboratorIds":{"type":"array","default":[],"items":{"type":"integer"}},"resourcesCardTitle":{"type":"string","default":""},"headingLevel":{"type":"string","default":"h2","enum":["h1","h2","h3","h4","h5","h6"]},"customCollaborators":{"type":"array","default":[],"items":{"type":"object","properties":{"id":{"type":"string"},"name":{"type":"string"},"url":{"type":"string"},"imageId":{"type":"integer"},"imageUrl":{"type":"string"},"imageAlt":{"type":"string"}}}},"enableCustomCollaborators":{"type":"boolean","default":false}},"example":{"attributes":{"blockId":"resources-example"}}}');

/***/ },

/***/ "./assets/src/blocks/resources/edit.js"
/*!*********************************************!*\
  !*** ./assets/src/blocks/resources/edit.js ***!
  \*********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const createRepeaterId = prefix => `${prefix}-${Date.now().toString(36)}-${Math.random().toString(36).slice(2, 8)}`;
...
const normalizeResourceCard = (card = {}) => ({
  ...
  title: card.title || '',
  pdfLinks: Array.isArray(card.pdfLinks) ? card.pdfLinks.map(normalizePdfLink) : []
});
...
const getCardKey = (card = {}) => card.id || `${card.title || 'resource-card'}-${card.pdfLinks?.length || 0}`;
const getPdfLinkKey = (link = {}) => link.id || `${link.label || 'resource-link'}-${link.url || 'empty'}`;
const getCollaboratorKey = (collaborator = {}) => collaborator.id || collaborator.url || collaborator.imageUrl || collaborator.name || 'resource-collaborator';
function Edit({
  attributes,
  setAttributes,
  clientId
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    const hasCardIds = resourceCards.every(card => card?.id && (card.pdfLinks || []).every(link => link?.id));
    const hasCollaboratorIds = customCollaborators.every(collaborator => collaborator?.id && collaborator?.imageAlt !== undefined);
    if (hasCardIds && hasCollaboratorIds) {
      return;
    }
    setAttributes({
      resourceCards: resourceCards.map(normalizeResourceCard),
      customCollaborators: customCollaborators.map(normalizeCustomCollaborator)
    });
  ...
  const collaborators = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => select('core').getEntityRecords('taxonomy', 'collaborator', {
    per_page: -1
  }), []);
  const collaboratorOptions = collaborators || [];
  const suggestions = collaboratorOptions.map(term => term.name);
  const defaultImages = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useMemo)(() => (0,_shared_components__WEBPACK_IMPORTED_MODULE_9__.DEFAULT_IMAGES)(), []);
  const downloadIcon = (0,_utils_assets__WEBPACK_IMPORTED_MODULE_8__.getThemeAssetUrl)('/assets/src/images/download-icon.svg');
  const selectedCollaboratorNames = collaboratorIds.map(id => {
  ...
  const addPdfLink = cardIndex => {
    ...
    const newLinks = [...currentLinks, normalizePdfLink({
      label: '',
      url: ''
    })];
    newCards[cardIndex] = {
  ...
  if (isExample) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_9__.BlockExamplePreview, {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_9__.TagSelector, {
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Manage Items', 'ambrygen-web'),
        children: [resourceCards.map((card, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
          className: "resources__pdf-link-editor",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
            className: "resources__card-settings-header",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("strong", {
              children: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Item', 'ambrygen-web'), " ", index + 1]
              ...
              children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Remove Item', 'ambrygen-web')
            })]
            ...
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Resources', 'ambrygen-web'),
            value: card.title,
            onChange: value => updateCards(index, 'title', value),
            placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Resources', 'ambrygen-web')
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("p", {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("strong", {
              children: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('PDF Downloads', 'ambrygen-web'), " (Max 2)"]
            })
          }), (card.pdfLinks || []).map((link, linkIndex) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
            className: "resources__pdf-link-editor",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
              className: "resources__pdf-link-editor-header",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("span", {
                children: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Link', 'ambrygen-web'), " ", linkIndex + 1]
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
                icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_7__["default"],
                isDestructive: true,
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Remove Link', 'ambrygen-web'),
                onClick: () => removePdfLink(index, linkIndex),
                size: "small"
              })]
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
              label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Label', 'ambrygen-web'),
              value: link.label,
              onChange: value => updatePdfLink(index, linkIndex, 'label', value),
              placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('e.g. EN', 'ambrygen-web')
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
              className: "resources__pdf-link-editor-controls",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
                className: "resources__pdf-link-editor-url",
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
                  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('File URL', 'ambrygen-web'),
                  value: link.url,
                  onChange: value => updatePdfLink(index, linkIndex, 'url', value)
                })
                ...
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
                  onSelect: media => updatePdfLink(index, linkIndex, 'url', media.url),
                  ...
                  render: ({
                    ...
                    icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_5__["default"],
                    variant: "secondary",
                    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Select PDF', 'ambrygen-web')
                  })
                })
              })]
            })]
          }, getPdfLinkKey(link))), (card.pdfLinks || []).length < 2 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
            variant: "secondary",
            icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_6__["default"],
            onClick: () => addPdfLink(index),
            className: "resources__full-width-btn",
            children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add PDF Link', 'ambrygen-web')
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("hr", {})]
        }, getCardKey(card))), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
          variant: "secondary",
          icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_6__["default"],
          onClick: addCard,
          className: "resources__full-width-btn",
          children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add New Item', 'ambrygen-web')
        })]
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Collaborators', 'ambrygen-web'),
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Collaborators', 'ambrygen-web'),
          value: enableCustomCollaborators ? 'manual' : 'taxonomy',
          options: [{
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Fetch from taxonomy', 'ambrygen-web'),
            value: 'taxonomy'
          }, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Set manually', 'ambrygen-web'),
            value: 'manual'
          }],
          onChange: value => setAttributes({
            enableCustomCollaborators: value === 'manual'
          })
        }), !enableCustomCollaborators && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.Fragment, {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("hr", {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.FormTokenField, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Fetch from taxonomy', 'ambrygen-web'),
            value: selectedCollaboratorNames,
            suggestions: suggestions,
            onChange: onCollaboratorsChange
          })]
        }), enableCustomCollaborators && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("hr", {}), enableCustomCollaborators && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
          className: "resources__custom-collabs-wrap",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("p", {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("strong", {
              children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Set manually', 'ambrygen-web')
            })
          }), customCollaborators.map((collab, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
            className: "resources__custom-collab-editor",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
              className: "resources__custom-collab-editor-header",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("span", {
                children: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Collaborator', 'ambrygen-web'), " ", index + 1]
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
                icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_7__["default"],
                isDestructive: true,
            ...
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_9__.CtaButtonField, {
              label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Link', 'ambrygen-web'),
              value: {
                url: collab.url || ''
              },
              onChange: value => updateCustomCollaboratorLink(index, value),
              showText: false,
              showVariant: false
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
              label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Name', 'ambrygen-web'),
              value: collab.name || '',
              onChange: value => updateCustomCollaborator(index, 'name', value)
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
              className: "resources__custom-collab-image",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("p", {
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("strong", {
                  children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('ICON', 'ambrygen-web')
                })
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_9__.ImageUploader, {
                url: collab.imageUrl,
                onSelect: media => {
                  const newCustom = [...customCollaborators];
                  newCustom[index] = {
          ...
          }, getCollaboratorKey(collab))), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
            variant: "secondary",
            icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_6__["default"],
            onClick: addCustomCollaborator,
            className: "resources__full-width-btn",
            children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Collaborator', 'ambrygen-web')
          })]
        })]
      })]
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
        ...
        }), hasHeading && hasSubtitle && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
        ...
        className: "resources__layout",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
          className: "test-lists-downloads",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
              ...
              className: "test-lists-downloads__list",
              children: resourceCards.map((card, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
                  ...
                  value: card.title,
                  onChange: value => updateCards(index, 'title', value),
                  placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Resources...', 'ambrygen-web')
                }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
                  className: "test-lists-downloads__links",
                  children: [(card.pdfLinks || []).map((link, linkIndex) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
                    className: "resources__link",
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("span", {
                      className: "resources__link-label",
                      children: link.label || (linkIndex === 0 ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Link 1', 'ambrygen-web') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Link 2', 'ambrygen-web'))
                    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("span", {
                      className: "resources__download-icon-placeholder",
                      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("img", {
                        src: downloadIcon,
                        alt: ""
                      })
                    })]
                  }, getPdfLinkKey(link))), (card.pdfLinks || []).length === 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
                    className: "resources__link",
                    children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('No Links', 'ambrygen-web')
                  })]
                })]
              }, getCardKey(card)))
            })]
          ...
          className: "resources__orgs-group",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
            className: "resources__card",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
              tagName: "h3",
              ...
              className: "resources__card-logo-grid resources__card-logo-grid--3-col",
              children: [collaboratorIds.length === 0 && (!enableCustomCollaborators || customCollaborators.length === 0) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
                className: "resources__logo-placeholder",
                children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Select Organizations in the sidebar', 'ambrygen-web')
              }), collaboratorIds.map(id => {
                const term = collaboratorOptions.find(item => item.id === id);
                return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
                  className: "resources__card-logo-link",
                  children: term?.name || id
                }, id);
              }), enableCustomCollaborators && customCollaborators.map((collab, index) => collab.url ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
                className: "resources__card-logo-link",
                children: collab.imageUrl || defaultImages?.placeholder?.url ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("img", {
                  src: collab.imageUrl || defaultImages.placeholder.url,
                  alt: collab.imageAlt || defaultImages?.placeholder?.alt || ''
                }) : collab.name || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Custom Collaborator', 'ambrygen-web')
              }, getCollaboratorKey(collab)) : null)]
            })]
          })
        })]
      })]
...
/***/ "./assets/src/blocks/resources/index.js"
/*!**********************************************!*\
  !*** ./assets/src/blocks/resources/index.js ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/resources/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/resources/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/resources/block.json");
...
/***/ "./assets/src/blocks/resources/style.scss"
/*!************************************************!*\
  !*** ./assets/src/blocks/resources/style.scss ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["resources/style-index"], () => (__webpack_require__("./assets/src/blocks/resources/index.js")))
