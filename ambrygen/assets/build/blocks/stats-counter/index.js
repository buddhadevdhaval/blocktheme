...
/***/ "./assets/src/blocks/stats-counter/block.json"
/*!****************************************************!*\
  !*** ./assets/src/blocks/stats-counter/block.json ***!
  \****************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/stats-counter","title":"Stats Counter","category":"ambrygen","icon":"chart-bar","description":"Displays a grid of counters with titles and descriptions.","supports":{"html":false},"keywords":["counter","statistics","numbers"],"attributes":{"blockId":{"type":"string","default":""},"counters":{"type":"array","default":[],"items":{"type":"object","properties":{"id":{"type":"string"},"prefix":{"type":"string"},"number":{"type":"string"},"postfix":{"type":"string"},"label":{"type":"string"},"description":{"type":"string"}}}}},"example":{"attributes":{"blockId":"stats-counter-example"}},"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js","render":"file:./render.php","textdomain":"ambrygen-web"}');

/***/ },

/***/ "./assets/src/blocks/stats-counter/edit.js"
/*!*************************************************!*\
  !*** ./assets/src/blocks/stats-counter/edit.js ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const DEFAULT_COUNTERS = [createCounter()];
const normalizeCounter = (counter = {}) => {
  var _ref, _counter$postfix, _ref2, _counter$label;
  return {
    id: counter.id || createCounterId(),
    prefix: counter.prefix || '',
    number: counter.number || '',
    // Map legacy suffix/title to postfix/label for backwards compatibility
    postfix: (_ref = (_counter$postfix = counter.postfix) !== null && _counter$postfix !== void 0 ? _counter$postfix : counter.suffix) !== null && _ref !== void 0 ? _ref : '',
    label: (_ref2 = (_counter$label = counter.label) !== null && _counter$label !== void 0 ? _counter$label : counter.title) !== null && _ref2 !== void 0 ? _ref2 : '',
...
function Edit({
  ...
  const [openStatId, setOpenStatId] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)(null);
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
  ...
  const removeCounter = counterId => {
    ...
    setAttributes({
      counters: counters.filter(counter => counter.id !== counterId).map(normalizeCounter)
    });
  };
  const moveCounter = (counterId, direction) => {
    const currentIndex = counters.findIndex(counter => counter.id === counterId);
    const nextIndex = currentIndex + direction;
    if (currentIndex < 0 || nextIndex < 0 || nextIndex >= counters.length) {
      return;
    }
    const updatedCounters = [...counters];
    [updatedCounters[currentIndex], updatedCounters[nextIndex]] = [updatedCounters[nextIndex], updatedCounters[currentIndex]];
    setAttributes({
      counters: updatedCounters.map(normalizeCounter)
    });
  };
  const toggleStat = id => {
  ...
  if (blockId === 'stats-counter-example') {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_6__.BlockExamplePreview, {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
          ...
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_6__.ItemHeader, {
              index: index,
              label: counter.label || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Untitled Stat', 'ambrygen-web'),
              total: counters.length,
              prefix: "STAT",
              onMove: (i, dir) => moveCounter(counters[i].id, dir),
              onRemove: i => removeCounter(counters[i].id),
              minCount: 1
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
              variant: "tertiary",
              icon: isOpen ? _wordpress_icons__WEBPACK_IMPORTED_MODULE_5__["default"] : _wordpress_icons__WEBPACK_IMPORTED_MODULE_4__["default"],
              ...
              children: isOpen ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Hide Fields', 'ambrygen-web') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Show Fields', 'ambrygen-web')
            }), isOpen && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
              className: "stats-counter__stat-controls",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
                ...
                onChange: value => updateCounter(counter.id, 'prefix', value)
                ...
                onChange: value => updateCounter(counter.id, 'postfix', value)
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Label', 'ambrygen-web'),
                value: counter.label,
                onChange: value => updateCounter(counter.id, 'label', value)
      ...
      children: counters.map(counter => {
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
          ...
          children: [hasNumberData && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
            className: "stats-counter__number heading-3 mb-0",
            children: [counter.prefix && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("span", {
              className: "stats-counter__number-prefix",
              children: counter.prefix
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("span", {
              className: "stats-counter__number-value",
              children: counter.number ? Number(counter.number).toLocaleString() : '0'
            }), counter.postfix && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("span", {
              className: "stats-counter__number-suffix",
              children: counter.postfix
            })]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
            className: "stats-counter__label subtitle1-sbold",
            children: counter.label || ''
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
            className: "is-style-gl-s8",
            "aria-hidden": "true"
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
            className: "stats-counter__description",
...
/***/ "./assets/src/blocks/stats-counter/editor.scss"
/*!*****************************************************!*\
  !*** ./assets/src/blocks/stats-counter/editor.scss ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./assets/src/blocks/stats-counter/index.js"
/*!**************************************************!*\
  !*** ./assets/src/blocks/stats-counter/index.js ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/stats-counter/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./assets/src/blocks/stats-counter/editor.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/stats-counter/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/stats-counter/block.json");
...
/***/ "./assets/src/blocks/stats-counter/style.scss"
/*!****************************************************!*\
  !*** ./assets/src/blocks/stats-counter/style.scss ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 		var installedChunks = {
/******/ 			"stats-counter/index": 0,
/******/ 			"stats-counter/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["stats-counter/style-index"], () => (__webpack_require__("./assets/src/blocks/stats-counter/index.js")))
