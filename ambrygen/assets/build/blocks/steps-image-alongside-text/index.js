...
/***/ "./assets/src/blocks/steps-image-alongside-text/block.json"
/*!*****************************************************************!*\
  !*** ./assets/src/blocks/steps-image-alongside-text/block.json ***!
  \*****************************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/steps-image-alongside-text","title":"Steps Image Alongside Text","category":"ambrygen","icon":"columns","description":"A layout with two stacked cards on the left and one large featured card on the right.","supports":{"html":false},"keywords":["cards","genetic","layout","grid"],"attributes":{"heading":{"type":"string","default":""},"headingTag":{"type":"string","enum":["h1","h2","h3","h4","h5","h6"],"default":"h2"},"description":{"type":"string","default":""},"blockId":{"type":"string"},"showFullImage":{"type":"boolean","default":false}},"variations":[{"name":"show-full-image","title":"Show full image","attributes":{"showFullImage":true}}],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js","textdomain":"ambrygen-web","example":{"attributes":{"blockId":"steps-image-alongside-text-example"}}}');

/***/ },

/***/ "./assets/src/blocks/steps-image-alongside-text/edit.js"
/*!**************************************************************!*\
  !*** ./assets/src/blocks/steps-image-alongside-text/edit.js ***!
  \**************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TEMPLATE = [['ambrygen/steps-image-alongside-text-item'], ['ambrygen/steps-image-alongside-text-item'], ['ambrygen/steps-image-alongside-text-item'], ['ambrygen/steps-image-alongside-text-item']];
function Edit({
  attributes,
  setAttributes,
  clientId
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useBlockProps)({
    className: `steps-iot-block ${showFullImage ? ' show-full-image' : ''}`
  });
  const containerRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useRef)(null);
  const activeIndex = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useRef)(0);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    ...
    const setActive = index => {
      const items = vTabsContainer.querySelectorAll('.vertical-tabs__item');
      items.forEach((el, i) => {
    ...
    const handleClick = e => {
      ...
      const items = Array.from(vTabsContainer.querySelectorAll('.vertical-tabs__item'));
    ...
    observer.observe(vTabsContainer, {
      childList: true,
      subtree: true
    });
    setActive(activeIndex.current);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Image Settings', 'ambrygen-web'),
        initialOpen: true,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Show full image', 'ambrygen-web'),
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
        className: "steps-iot-block__header block__rowflex",
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.InnerBlocks, {
          allowedBlocks: ['ambrygen/steps-image-alongside-text-item'],
          template: TEMPLATE,
        ...
        variant: "primary",
        onClick: () => {
          insertBlock((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.createBlock)('ambrygen/steps-image-alongside-text-item'), undefined, clientId);
        },
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Add New Record', 'ambrygen-web')
      })]
    })]
  });
}
...
/***/ "./assets/src/blocks/steps-image-alongside-text/editor.scss"
/*!******************************************************************!*\
  !*** ./assets/src/blocks/steps-image-alongside-text/editor.scss ***!
  \******************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./assets/src/blocks/steps-image-alongside-text/index.js"
/*!***************************************************************!*\
  !*** ./assets/src/blocks/steps-image-alongside-text/index.js ***!
  \***************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/steps-image-alongside-text/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./assets/src/blocks/steps-image-alongside-text/editor.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/steps-image-alongside-text/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/steps-image-alongside-text/block.json");
...
/***/ "./assets/src/blocks/steps-image-alongside-text/style.scss"
/*!*****************************************************************!*\
  !*** ./assets/src/blocks/steps-image-alongside-text/style.scss ***!
  \*****************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 		var installedChunks = {
/******/ 			"steps-image-alongside-text/index": 0,
/******/ 			"steps-image-alongside-text/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["steps-image-alongside-text/style-index"], () => (__webpack_require__("./assets/src/blocks/steps-image-alongside-text/index.js")))
