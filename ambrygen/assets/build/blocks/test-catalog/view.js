/******/ (() => { // webpackBootstrap
/*!************************************************!*\
  !*** ./assets/src/blocks/test-catalog/view.js ***!
  \************************************************/
document.addEventListener('DOMContentLoaded', () => {
  ...
  blocks.forEach(block => {
    ...
    const trackingLinks = Array.from(block.querySelectorAll('.test-catlouge__link[data-material-id][data-file-id]'));
    ...
    if (clickEndpoint && typeof fetch === 'function' && trackingLinks.length) {
      trackingLinks.forEach(link => {
        link.addEventListener('click', () => {
          const materialId = Number(link.getAttribute('data-material-id'));
