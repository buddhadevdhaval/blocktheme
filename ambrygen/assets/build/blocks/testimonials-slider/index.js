...
/***/ "./assets/src/blocks/testimonials-slider/block.json"
/*!**********************************************************!*\
  !*** ./assets/src/blocks/testimonials-slider/block.json ***!
  \**********************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/testimonials-slider","title":"Testimonials Slider","category":"ambrygen","icon":"format-quote","description":"Displays a slider of testimonials with content and logos.","supports":{"html":false,"align":["wide","full"],"spacing":{"margin":true,"padding":true}},"attributes":{"blockId":{"type":"string"},"title":{"type":"string"},"headingTag":{"type":"string","enum":["h1","h2","h3","h4","h5","h6"],"default":"h2"},"testimonials":{"type":"array","default":[]},"autoplay":{"type":"boolean","default":false},"showNavigation":{"type":"boolean","default":true},"showPagination":{"type":"boolean","default":true},"graphicLeftId":{"type":"number","default":0},"graphicLeftUrl":{"type":"string","default":""},"graphicLeftAlt":{"type":"string","default":""},"graphicRightId":{"type":"number","default":0},"graphicRightUrl":{"type":"string","default":""},"graphicRightAlt":{"type":"string","default":""}},"editorScript":"file:./index.js","editorStyle":"file:./editor.scss","style":"file:./style-index.css","viewScript":"file:./view.js","render":"file:./render.php","textdomain":"ambrygen-web","example":{"attributes":{"blockId":"testimonials-slider-example"}}}');

/***/ },

/***/ "./assets/src/blocks/testimonials-slider/edit.js"
/*!*******************************************************!*\
  !*** ./assets/src/blocks/testimonials-slider/edit.js ***!
  \*******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const createSliderItemBlock = (testimonial = {}) => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.createBlock)('ambrygen/testimonials-slider-item', {
...
function Edit({
  ...
  const swiperRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useRef)(null);
  const [activeSlideIndex, setActiveSlideIndex] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useState)(0);
  const {
    insertBlock,
    replaceInnerBlocks
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useDispatch)('core/block-editor');
  const innerBlocks = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.store).getBlocks(clientId), [clientId]);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    replaceInnerBlocks(clientId, testimonials.map(createSliderItemBlock), false);
    setAttributes({
      testimonials: []
    });
  }, [clientId, hasInnerBlocks, replaceInnerBlocks, setAttributes, testimonials]);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    const sliderElement = swiperRef.current;
    const sliderLayout = sliderElement?.querySelector('.block-editor-block-list__layout');
    if (!sliderLayout) {
      return;
    }
    [...sliderLayout.children].forEach((slideElement, index) => {
      slideElement.classList.toggle('is-editor-active-slide', index === activeSlideIndex);
      slideElement.classList.toggle('is-editor-inactive-slide', index !== activeSlideIndex);
      slideElement.style.display = index === activeSlideIndex ? 'block' : 'none';
      slideElement.setAttribute('aria-hidden', index === activeSlideIndex ? 'false' : 'true');
    });
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    const autoplayTimer = window.setInterval(() => {
      setActiveSlideIndex(currentIndex => (currentIndex + 1) % innerBlocks.length);
    }, 3000);
  ...
  const showPreviousSlide = () => {
    ...
    setActiveSlideIndex(currentIndex => currentIndex === 0 ? innerBlocks.length - 1 : currentIndex - 1);
  };
  const showNextSlide = () => {
    if (innerBlocks.length <= 1) {
      return;
    }
    setActiveSlideIndex(currentIndex => currentIndex === innerBlocks.length - 1 ? 0 : currentIndex + 1);
  };
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.BlockControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarButton, {
          icon: "plus-alt2",
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Add item', 'ambrygen-web'),
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Graphic Image', 'ambrygen-web'),
        initialOpen: false,
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_9__.ImageUploader, {
          url: graphicLeftUrl,
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Left Graphic Image', 'ambrygen-web'),
          onSelect: media => {
            setAttributes({
          ...
          url: graphicRightUrl,
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Right Graphic Image', 'ambrygen-web'),
          onSelect: media => {
            setAttributes({
      ...
      ...blockProps,
      children: [hasGraphicImages && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
        className: "graphic-images",
        "aria-hidden": "true",
        children: [hasLeftGraphic && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
          className: "graphic-images__overlay-left graphic-images__img-block",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("img", {
            src: graphicLeftUrl,
            className: "overlay__img",
            alt: graphicLeftAlt
          })
        }), hasRightGraphic && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
          className: "graphic-images__overlay-right graphic-images__img-block",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("img", {
            src: graphicRightUrl,
            className: "overlay__img",
            alt: graphicRightAlt
        ...
        className: "testimonial-slider__inner",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
          className: "testimonial-slider__header",
        ...
        }), hasTitle && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
          className: "is-style-gl-s50",
          "aria-hidden": "true"
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
          className: "testimonial-slider__swiper",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
            ref: swiperRef,
          ...
          }), showNavigation && hasMultipleSlides && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
          ...
          }), showPagination && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
            className: "swiper-pagination testimonial-swiper-pagination",
            children: hasMultipleSlides && innerBlocks.map((block, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("span", {
              className: `swiper-pagination-bullet${index === activeSlideIndex ? ' swiper-pagination-bullet-active' : ''}`,
...
/***/ "./assets/src/blocks/testimonials-slider/editor.scss"
/*!***********************************************************!*\
  !*** ./assets/src/blocks/testimonials-slider/editor.scss ***!
  \***********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./assets/src/blocks/testimonials-slider/index.js"
/*!********************************************************!*\
  !*** ./assets/src/blocks/testimonials-slider/index.js ***!
  \********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/testimonials-slider/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./assets/src/blocks/testimonials-slider/editor.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/testimonials-slider/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/testimonials-slider/block.json");
...
/***/ "./assets/src/blocks/testimonials-slider/style.scss"
/*!**********************************************************!*\
  !*** ./assets/src/blocks/testimonials-slider/style.scss ***!
  \**********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 		var installedChunks = {
/******/ 			"testimonials-slider/index": 0,
/******/ 			"testimonials-slider/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["testimonials-slider/style-index"], () => (__webpack_require__("./assets/src/blocks/testimonials-slider/index.js")))
