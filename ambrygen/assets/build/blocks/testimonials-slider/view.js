...
(() => {
/*!*******************************************************!*\
  !*** ./assets/src/blocks/testimonials-slider/view.js ***!
  \*******************************************************/
__webpack_require__.r(__webpack_exports__);
...
const initTestimonialSliders = () => {
  ...
  testimonialSliders.forEach(sliderElement => {
    ...
    const slidesPerView = Math.max(1, parseInt(sliderElement.dataset.slidesPerView || '1', 10) || 1);
    const autoplayEnabled = sliderElement.dataset.autoplay === 'true';
    const paginationElement = sliderRoot.querySelector('.testimonial-swiper-pagination');
    ...
    const swiperInstance = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderElement, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectFade, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Keyboard, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.A11y],
      loop: slideCount > 1,
