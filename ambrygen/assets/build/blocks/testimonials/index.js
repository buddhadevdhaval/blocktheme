...
/***/ "./assets/src/blocks/testimonials/block.json"
/*!***************************************************!*\
  !*** ./assets/src/blocks/testimonials/block.json ***!
  \***************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ambrygen/testimonials","title":"Testimonials","category":"ambrygen","icon":"format-quote","supports":{"color":{"background":true}},"attributes":{"blockId":{"type":"string","default":""},"heading":{"type":"string","default":""},"headingTag":{"type":"string","enum":["h1","h2","h3","h4","h5","h6"],"default":"h2"},"mainImage":{"type":"string","default":""},"mainImageId":{"type":"number","default":0},"mainImageAlt":{"type":"string","default":""},"secondaryImage":{"type":"string","default":""},"secondaryImageId":{"type":"number","default":null},"secondaryImageAlt":{"type":"string","default":""},"overlayImage":{"type":"string","default":""},"overlayImageId":{"type":"number","default":null},"overlayImageAlt":{"type":"string","default":""}},"editorScript":"file:./index.js","render":"file:./render.php","editorStyle":"file:./index.css","style":"file:./style-index.css","textdomain":"ambrygen-web","viewScript":"file:./view.js","providesContext":{"ambrygen/mainImage":"mainImage","ambrygen/mainImageId":"mainImageId","ambrygen/mainImageAlt":"mainImageAlt"},"example":{"attributes":{"blockId":"testimonials-example"}}}');

/***/ },

/***/ "./assets/src/blocks/testimonials/edit.js"
/*!************************************************!*\
  !*** ./assets/src/blocks/testimonials/edit.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function Edit({
  ...
  const TEMPLATE = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useMemo)(() => [['ambrygen/testimonial-item', {
    quote: '',
    author: '',
    role: ''
   ...
   * @type {boolean}
   */
  const hasInnerBlocks = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.store).getBlocks(clientId).some(block => block.name === ITEM_BLOCK_NAME), [clientId]);
  const {
    insertBlock
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("section", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelBody, {
        ...
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Image Settings', 'ambrygen-web'),
        initialOpen: false,
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_6__.ImageUploader, {
          url: overlayImage,
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Top Left Overlay Image', 'ambrygen-web'),
          onSelect: media => updateImage(media, 'overlayImage'),
          onRemove: () => setAttributes({
            overlayImage: '',
            overlayImageId: null,
            overlayImageAlt: ''
          })
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_shared_components__WEBPACK_IMPORTED_MODULE_6__.ImageUploader, {
          url: secondaryImage,
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Bottom Right Overlay Image', 'ambrygen-web'),
          onSelect: media => updateImage(media, 'secondaryImage'),
          onRemove: () => setAttributes({
            secondaryImage: '',
          ...
          url: mainImage,
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Image', 'ambrygen-web'),
          onSelect: media => updateImage(media, 'mainImage'),
          onRemove: () => setAttributes({
            mainImage: '',
            mainImageId: null,
            mainImageAlt: ''
      ...
      className: "ambry-testimonials__graphic-images",
      children: [overlayImage && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
        className: "ambry-testimonials__graphic-images__overlay-left ambry-testimonials__graphic-images__img-block",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("img", {
          src: overlayImage,
          className: "overlay__img",
          alt: overlayImageAlt || ''
        })
      }), secondaryImage && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
        className: "ambry-testimonials__graphic-images__overlay-right ambry-testimonials__graphic-images__img-block",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("img", {
          src: secondaryImage,
          className: "overlay__img",
      ...
      className: "ambry-testimonials__layout",
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
        className: "ambry-testimonials__grid",
      ...
      variant: "primary",
      onClick: () => {
        insertBlock((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.createBlock)(ITEM_BLOCK_NAME), undefined, clientId);
      },
      children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Add Testimonial Item', 'ambrygen-web')
    })]
  });
}
...
/***/ "./assets/src/blocks/testimonials/editor.scss"
/*!****************************************************!*\
  !*** ./assets/src/blocks/testimonials/editor.scss ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./assets/src/blocks/testimonials/index.js"
/*!*************************************************!*\
  !*** ./assets/src/blocks/testimonials/index.js ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./assets/src/blocks/testimonials/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./assets/src/blocks/testimonials/editor.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./assets/src/blocks/testimonials/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./assets/src/blocks/testimonials/block.json");
...
/***/ "./assets/src/blocks/testimonials/style.scss"
/*!***************************************************!*\
  !*** ./assets/src/blocks/testimonials/style.scss ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["testimonials/style-index"], () => (__webpack_require__("./assets/src/blocks/testimonials/index.js")))
