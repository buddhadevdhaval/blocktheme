...
(() => {
/*!***********************************************!*\
  !*** ./assets/src/blocks/theme-video/view.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    modal.innerHTML = `
			...
			<div class="modal-popup__panel" role="dialog" aria-modal="true">
				<button type="button" class="modal-popup__close" aria-label="Close modal">
					<img decoding="async" src="${_images_close_icon_svg__WEBPACK_IMPORTED_MODULE_0__["default"]}" alt="Close" />
				</button>
  ...
  blocks.forEach(block => {
    ...
    const iframe = block.querySelector('.features-media__video-wrapper--iframe iframe');
    if (!video && !iframe) {
      return;
    }
    let modal = null;
