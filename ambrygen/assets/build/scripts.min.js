...
var map = {
	...
	"./toc.js": "./assets/src/js/partials/toc.js"
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  buttons.forEach(btn => {
    btn.addEventListener("click", function () {
      ...
      activeCategory = this.dataset.term && this.dataset.term !== "0" ? this.dataset.term : "";
      currentPage = 1;
      loadPosts(true);
    });
  });
  ...
  function updateBrowserUrl() {
    ...
    if (activeCategory !== "" && activeCategory !== "0" && activeCategory !== 0 && activeCategory !== null && activeCategory !== undefined) {
  ...
  document.addEventListener('click', e => {
    ...
    const copy = str => {
      if (navigator.clipboard?.writeText) {
        navigator.clipboard.writeText(str).then(() => showTip('Link copied!')).catch(() => showTip('Failed to copy'));
      } else {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.combo-color-row h2, .combo-color-row h3, .combo-color-row h4, .combo-color-row h5').forEach(function (heading) {
    const baseId = heading.textContent.toLowerCase().replace(/[^a-zA-Z0-9 ]/g, '').replace(/\s+/g, '-').trim();
    if (heading.closest('a')?.querySelector('img') || heading.querySelector('img') || heading.previousElementSibling?.tagName === 'IMG' || heading.closest('.sidebar-items')) {
