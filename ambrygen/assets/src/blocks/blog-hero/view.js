( function () {
	const initBlogHeroVideo = () => {
		const heroBlocks = document.querySelectorAll(
			'.blog-detail-hero.blog-featured'
		);
		...
		heroBlocks.forEach( ( block ) => {
			...
			const videoContainer = modal.querySelector(
			...
			const openModal = () => {
				...
				document.body.style.overflow = ''; // Prevent inline style conflicts
