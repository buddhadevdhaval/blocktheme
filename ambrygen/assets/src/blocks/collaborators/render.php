...
<div <?php echo $ambrygen_wrapper_attributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	<?php if ( ! empty( $ambrygen_title ) || ! empty( $ambrygen_intro ) ) : ?>
		<div class="collaborators__header block__rowflex">
			<?php if ( ! empty( $ambrygen_title ) ) : ?>
				<<?php echo tag_escape( $ambrygen_heading_level ); ?> class="collaborators__title block__rowflex--heading-title heading-3 mb-0 js-gsap-fade">
					<?php echo wp_kses_post( $ambrygen_title ); ?>
				</<?php echo tag_escape( $ambrygen_heading_level ); ?>>
			<?php endif; ?>

			<?php if ( ! empty( $ambrygen_intro ) ) : ?>
				<div class="collaborators__intro block__rowflex--block-content subtitle1 js-gsap-fade">
