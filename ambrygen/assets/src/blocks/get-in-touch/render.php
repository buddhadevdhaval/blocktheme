...
<div <?php echo $ambrygen_wrapper_attributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Generated by get_block_wrapper_attributes(). ?>>
	...
	<div class="heading-center center-align">
		<?php if ( $ambrygen_title ) : ?>
			<<?php echo tag_escape( $ambrygen_heading_level ); ?> id="<?php echo esc_attr( $ambrygen_heading_id ); ?>" class="heading-3 block-title mb-0 js-gsap-fade">
	...
	<?php if ( ! empty( $ambrygen_block_content ) ) : ?>
		<section class="contact-form-block__form js-gsap-fade"
			<?php if ( $ambrygen_title ) : ?>
			...
			<?php endif; ?>
		>
			<?php echo $ambrygen_block_content; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- InnerBlocks content is rendered by WordPress. ?>
		</section>
	<?php endif; ?>
