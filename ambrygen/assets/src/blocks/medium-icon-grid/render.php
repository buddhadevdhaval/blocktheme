...
$ambrygen_heading_tag_name = $attributes['headingTag'] ?? 'h2';
$ambrygen_description      = $attributes['description'] ?? '';
$ambrygen_cards_content    = trim( $content );
$ambrygen_heading_tag      = Helper::get_heading_tag( $ambrygen_heading_tag_name, 'h2' );
