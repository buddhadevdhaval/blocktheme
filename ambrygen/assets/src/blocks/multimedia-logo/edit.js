...
function DownloadPanel( {
	...
	const groupDownloads = downloads.reduce( ( entries, item, index ) => {
		if ( item.group === group ) {
			...
			<InspectorControls>
				...
				>
					<DownloadPanel
						...
						updateDownloadMedia={ updateDownloadMedia }
						clearDownloadMedia={ clearDownloadMedia }
						...
						<div className="logo-section__downloads-group">
							...
							<div className="logo-section__downloads-list">
								...
								{ webDownloads.map( ( item ) => (
									...
									>
										<div className="logo-section__downloads-link text-small">
