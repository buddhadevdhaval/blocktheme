...
if ( ! is_string( $ambrygen_post_title ) ) {
	$ambrygen_post_title = '';
}

if ( '' !== $ambrygen_post_title && false !== strpos( $ambrygen_title, '{title}' ) ) {
	$ambrygen_title = str_replace( '{title}', $ambrygen_post_title, $ambrygen_title );
}
...
<div class="sidebar-widget order-widget">
	...
	<div class="widget-content">
		...
		<?php
		$has_tagline_line_one = '' !== trim( wp_strip_all_tags( $ambrygen_tagline_line_one ) );
		?>

<?php if ( $has_tagline_line_one ) : ?>
