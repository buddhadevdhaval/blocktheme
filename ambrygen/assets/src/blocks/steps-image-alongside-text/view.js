...
document.addEventListener( 'DOMContentLoaded', () => {
	document
		.querySelectorAll( '.vertical-tabs' )
		.forEach( ( vTabsContainer ) => {
			...
			vItems.forEach( ( item, index ) => {
				const stepLabel = item.querySelector(
					'.vertical-tabs__step-label'
				);
