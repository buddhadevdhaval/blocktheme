...
export default function Edit({
	...
	const blockProps = useBlockProps({
		className: `image-grid-block video-grid wp-block-ambrygen-gallery block-${variation} ${ambClass} grid-column${innerBlocksCount >= 3 ? 3 : 2
			}`,
	});
	return (
		<>
			...
			<section {...blockProps}>
				<div
					className={`two-column-videos${variation === 'variation-3' ? ' row-videos' : ''
						}`}
				>
