...
final class WebinarAuthorRepeaterField
{
    ...
    public function render(int $post_id, string $key, array $field): void
    {
        ...
        echo '</div>';
        echo '<p><button type="button" class="button button-secondary ambrygen-mm-add-row">' . esc_html__('Add Author', 'ambrygen-web') . '</button></p>';
    ...
    public function render_row_html(string $key, string $index, array $row): string
    {
        ...
        <div class="ambrygen-mm-row" style="border:1px solid #dcdcde;padding:12px;margin:0 0 12px 0;background:#fff;">
            <p>
                <label><?php esc_html_e('Linked Author', 'ambrygen-web'); ?></label><br />
                <input
                    type="text"
            ...
            <div class="ambrygen-media-file-field" style="margin-bottom:12px;">
                ...
                <div class="form-field form-field-button">
                    <button type="button" class="button button-secondary ambrygen-media-file-upload"><?php esc_html_e('Select Image', 'ambrygen-web'); ?></button>
                    <button type="button" class="button button-secondary ambrygen-media-file-remove"><?php esc_html_e('Clear', 'ambrygen-web'); ?></button>
                </div>
            </div>

            <p>
                <label><?php esc_html_e('Designation Override', 'ambrygen-web'); ?></label><br />
