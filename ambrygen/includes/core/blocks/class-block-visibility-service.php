...
/**
 * Filter rendered block output for archive-specific visibility and pagination behavior.
 */
final class BlockVisibilityService {
	...
	/**
	 * Register block rendering and pagination filters.
	 */
	...
	/**
	 * Reformat collaborator terms on single poster output.
	 *
	...
	/**
	 * Reformat post tag terms for card topic lists.
	 *
	 * @param string $block_content Rendered block markup.
	 * @param array  $block         Parsed block data.
	 * @return string
	...
	/**
	 * Reformat poster category terms into category chip markup.
	 *
	 * @param string $block_content Rendered block markup.
	 * @param array  $block         Parsed block data.
	 * @return string
	...
	/**
	 * Reformat collaborator term output on science archives and singles.
	 *
	 * @param string $block_content Rendered block markup.
	 * @param array  $block         Parsed block data.
	 * @return string
	...
	/**
	 * Unwrap list markup for targeted post-template blocks.
	 *
	 * @param string $block_content Rendered block markup.
	 * @param array  $block         Parsed block data.
	 * @return string
	...
	/**
	 * Replace empty conference tab content with configured empty states.
	 *
	 * @param string $block_content Rendered block markup.
	 * @param array  $block         Parsed block data.
	 * @return string
	...
	public function filter_tabs_content( string $block_content, array $block ): string {
		...
		$scope = 'upcoming';
		if ( false !== strpos( $block_content, 'id="conference-tabs-past"' ) ) {
			$scope = 'past';
		} elseif ( 'conferences' === get_post_type( $post_id ) && BlockRenderService::instance()->is_past_conference( (int) $post_id ) ) {
			$scope = 'past';
		}

		if ( ! BlockRenderService::instance()->has_conference_data( (int) $post_id ) ) {
			return BlockRenderService::instance()->render_conference_empty_message( $scope, (int) $post_id );
		}
	...
	/**
	 * Constrain related-articles query blocks to sibling blog categories.
	 *
	 * @param array $query Query loop vars.
	 * @param mixed $block Current block object.
	 * @return array
	 */
	...
	/**
	 * Hide in-progress wrappers when there is no in-progress content.
	 *
	 * @param string $block_content Rendered block markup.
	 * @param array  $block         Parsed block data.
	 * @return string
	...
	/**
	 * Replace back-link placeholders with archive URLs.
	 *
	 * @param string $block_content Rendered block markup.
	 * @param array  $block         Parsed block data.
	 * @return string
	...
	/**
	 * Inject science archive post-type labels before poster-category titles.
	 *
	 * @param string $block_content Rendered block markup.
	 * @param array  $block         Parsed block data.
	 * @return string
	 ...
	 * @param int    $tag         Active tag filter.
	...
	/**
	 * Build condensed pagination list button markup.
	 *
	 * @param int $paged       Current page.
	 * @param int $total_pages Total pages.
	 * @return string
	...
	/**
	 * Build popup pagination grid button markup.
	 *
	 * @param int $paged       Current page.
	 * @param int $total_pages Total pages.
	 * @return string
	...
	/**
	 * Convert archive pagination links into button-based controls.
	 *
	 * @param string $block_content Rendered block markup.
	 * @param array  $block         Parsed block data.
	 * @return string
	...
	/**
	 * Render condensed pagination numbers for poster-category archives.
	 *
	 * @return string
	 */
	...
	/**
	 * Update the per-page dropdown in rendered archive HTML.
	 *
	 * @param string $html     Rendered HTML.
	 * @param int    $per_page Selected per-page value.
	 * @param string $suffix   Scope-specific suffix.
	 * @return string
	 */
	 ...
	 * @param string $html           Rendered HTML.
	 * @param string $scope          Archive scope.
	 * @param int    $current_tag_id Active tag term ID.
	 * @param string $post_type      Post type slug.
	 * @return string
	 */
