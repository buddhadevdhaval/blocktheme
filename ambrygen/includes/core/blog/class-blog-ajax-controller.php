...
/**
 * AJAX controller for blog archive pagination.
 */
final class BlogAjaxController {
	...
	/**
	 * Register AJAX hooks for blog pagination.
	 */
	protected function __construct() {
		add_action( 'wp_ajax_ambrygen_blog_pagination', array( $this, 'handle_pagination' ) );
		add_action( 'wp_ajax_nopriv_ambrygen_blog_pagination', array( $this, 'handle_pagination' ) );
	}
