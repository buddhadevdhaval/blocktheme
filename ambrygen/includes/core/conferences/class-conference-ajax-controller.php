...
/**
 * AJAX controller for conference archive interactions.
 */
final class ConferenceAjaxController {
	...
	private function register_hooks(): void {
		add_action( 'wp_ajax_ambrygen_conference_pagination', array( $this, 'handle_pagination' ) );
		add_action( 'wp_ajax_nopriv_ambrygen_conference_pagination', array( $this, 'handle_pagination' ) );
	}

	/**
	 * Handle conference archive pagination requests.
	 *
	 * @return void
	 */
	...
	/**
	 * Render archive content from the matching template part.
	 *
	...
	/**
	 * Find the first query block in a parsed block list.
	 *
	...
	/**
	 * Find the first block with a matching block name.
	 *
	 * @param array  $blocks     Parsed blocks.
	...
	/**
	 * Replace static pagination markup with dynamic archive pagination.
	 *
	...
	/**
	 * Generate pagination list markup.
	 *
	 * @param int $paged       Current page number.
	 * @param int $total_pages Total number of pages.
	 * @return string
	...
	/**
	 * Generate the popup grid markup for archive pagination.
	 *
	 * @param int $paged       Current page number.
	 * @param int $total_pages Total number of pages.
	 * @return string
	...
	/**
	 * Update the per-page dropdown selection in rendered markup.
	 *
	 * @param string $html     Rendered HTML.
	 * @param int    $per_page Selected per-page value.
	 * @param string $suffix   Archive selector suffix.
	 * @return string
	 */
	...
	/**
	 * Update the year dropdown selection in rendered markup.
	 *
	 * @param string $html Rendered HTML.
	 * @param int    $year Selected year.
	 * @return string
	...
	/**
	 * Update the active tabs in rendered archive markup.
	 *
	 * @param string $html  Rendered HTML.
